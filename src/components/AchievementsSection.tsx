import { Trophy, Award, Star, Zap, Target, Code2, GraduationCap, Flame } from "lucide-react";
...
const AchievementsSection = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-heading font-bold text-foreground mb-2">Achievements</h2>
        <p className="text-muted-foreground">Unlock badges as you progress through your learning journey</p>
      </div>
      ...
      <Card className="border-border shadow-purple bg-gradient-card">
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-primary-foreground">Overall Progress</h3>
          ...
          >
            <CardContent className="p-6 text-center space-y-4">
              ...
              >
                <achievement.icon
                  className={`w-10 h-10 ${
                    achievement.unlocked ? "text-secondary" : "text-muted-foreground"
                  }`}
                />
              </div>
