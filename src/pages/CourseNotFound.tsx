...
const CourseNotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-primary/90 to-secondary/20 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute bottom-1/4 right-1/4 text-cyan/30 text-9xl font-mono animate-pulse" style={{ animationDelay: '1s' }}>
        {'}'}
      </div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="relative">
            <h1 className="text-9xl md:text-[12rem] font-bold text-cyan animate-glitch leading-none mb-4"
                style={{
            ...
            <div className="absolute inset-0 text-9xl md:text-[12rem] font-bold text-secondary/50 animate-glitch-2 leading-none"
          ...
          <div className="space-y-4 text-white">
            <h2 className="text-3xl md:text-4xl font-heading font-bold">
              Houston, we have a <span className="text-cyan">syntax error</span>.
            </h2>
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto">
              The course you're looking for has been deleted, renamed, or is temporarily unavailable.
            </p>
            <p className="text-base text-cyan/90">
              Either the URL is drunk, or you just discovered a secret level. Either way… let's get you back on track.
            </p>
          </div>
