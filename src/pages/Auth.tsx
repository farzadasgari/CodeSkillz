...
const Auth = () => {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to CodeSkillz! Check your email to verify your account.",
    });
  };
          ...
          <div className="hidden lg:block">
            <div className="bg-gradient-card p-8 rounded-lg shadow-purple">
              <h2 className="text-3xl font-heading font-bold text-primary-foreground mb-6">
                Join the Code<span className="text-secondary">Skillz</span> Revolution
              </h2>
                  ...
                  <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <label htmlFor="terms" className="text-sm leading-relaxed cursor-pointer">
                        I agree to the{" "}
                        <Link to="/terms-of-service" className="text-primary hover:text-secondary transition-colors">
                          Terms of Service
                        </Link>{" "}
                        and{" "}
                        <Link to="/privacy-policy" className="text-primary hover:text-secondary transition-colors">
                          Privacy Policy
                        </Link>
                      </label>
                    </div>
