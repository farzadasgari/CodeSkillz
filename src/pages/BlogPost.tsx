        ...
        <div className="min-h-screen bg-background mt-10">
            <div className="bg-gradient-hero pt-20 pb-16 px-4">
                <div className="container mx-auto max-w-4xl">
                    <Button
                        variant="outline"
                        className="mb-6 text-primary-foreground border-primary-foreground hover:bg-primary-foreground/10"
                        asChild
                    >
                        <Link to="/blog">
            ...
            <article className="container mx-auto max-w-4xl px-4 py-16">
                <div className="bg-card rounded-lg p-8 md:p-12 shadow-lg border border-border">
                                ...
                                .map((paragraph, index) => {
                                    ...
                                    if (paragraph.startsWith('## ')) {
                                        return (
                                            <h3
                                                key={index}
                                                className="text-2xl font-heading font-bold text-primary mt-6 mb-3"
                                            >
                                                {paragraph.replace('## ', '')}
                                            </h3>
                                        );
                                    ...
                                    if (paragraph.startsWith('### ')) {
                                        return (
                                            <h4
                                                key={index}
                                                className="text-xl font-heading font-semibold text-foreground mt-4 mb-2"
                                            >
                                                {paragraph.replace('### ', '')}
                                            </h4>
                                        );
                    ...
                    {(post.category === 'Coding Tutorials' ||
                        post.category === 'Research Insights') && (
