                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-muted-foreground leading-relaxed mb-8">
                                Whether you have questions about courses, need
                                support, or want to discuss collaboration
                                opportunities, we're here to help. Send us a
                        ...
                        <div className="p-6 bg-muted rounded-lg">
                            ...
                            <p className="text-muted-foreground text-sm mb-4">
                                Check out our FAQ section for instant answers to
                                common questions
                            </p>
                            <Link to="/faq">
                                <Button
