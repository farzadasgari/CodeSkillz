  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-destructive/5 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 border-4 border-destructive/30 animate-pulse" style={{ animationDuration: '3s' }} />
      </div>
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <Lock className="w-96 h-96 text-primary/20 animate-spin" style={{ animationDuration: '20s' }} />
        </div>
      ...
      <div className="absolute top-8 right-8 animate-pulse">
        <div className="relative">
          ...
          <div className="text-xs text-muted-foreground text-center mt-1 font-mono">SCANNING...</div>
        </div>
      </div>
      ...
      <div className="text-center space-y-8 max-w-2xl relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 text-9xl font-heading font-bold text-destructive/20 animate-pulse" style={{ animationDelay: '0.1s' }}>
            403
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-cyan text-sm italic pt-2">
              This area is guarded by Farzad's legendary firewall.<br />
          ...
          <div className="bg-background/80 backdrop-blur-sm border border-cyan/30 rounded-lg p-6 text-left font-mono text-sm space-y-1 shadow-elegant">
            <div className="text-cyan">&gt; Checking credentials...</div>
            <div className="text-destructive">&gt; Permission denied.</div>
            <div className="text-amber-500">&gt; Intruder alert level: Medium</div>
            <div className="text-cyan">&gt; Suggested action: Enroll in a course</div>
        ...
        <div className="pt-2">
          <Link to="/auth" className="text-sm text-cyan hover:text-cyan/80 transition-colors underline">
