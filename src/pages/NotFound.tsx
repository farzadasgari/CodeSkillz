                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-cyan/90 text-background px-8 py-6 rounded-lg shadow-glow animate-scale-in z-50">
                    <div className="text-center space-y-3">
                        ...
                        <div className="font-bold text-xl">
                            Matrix Explorer Badge Unlocked!
                        </div>
                        <div className="text-sm">
                            You've discovered the secret! Check your profile.
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className="text-center space-y-8 max-w-2xl relative z-10">
                <div className="space-y-4">
                    <div className="relative">
                        ...
                        <h1
                            className="text-9xl md:text-[12rem] font-heading font-bold text-primary absolute inset-0 opacity-70 animate-pulse"
                            style={{
                                animationDelay: '0.1s',
                        ...
                        <h1
                            className="text-9xl md:text-[12rem] font-heading font-bold text-destructive absolute inset-0 opacity-50 animate-pulse"
                            style={{
                                animationDelay: '0.2s',
                                transform: 'translate(-2px, -2px)',
                            }}
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-lg text-muted-foreground max-w-xl mx-auto">
                            The page you're looking for has been deleted,
