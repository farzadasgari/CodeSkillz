...
export const courses: Course[] = [
    ...
    },
    {
        ...
        description: "Learn the core building blocks of modern web development: HTML, CSS, and Bootstrap.",
        longDescription:
    ...
    },
    {
        ...
        description: "Learn ML algorithms, neural networks, and deep learning with practical projects and industry insights.",
        longDescription:
    ...
    },
    {
        ...
        description: "Master advanced JavaScript concepts and build dynamic applications with modern frameworks.",
        longDescription:
    ...
    },
    {
        ...
        description: "Learn user-centered design, wireframing, and interface design using Figma and modern principles.",
        longDescription:
    ...
    },
    {
        ...
        description: "Build modern, responsive web applications with HTML, CSS, JavaScript, and popular frameworks.",
        longDescription:
...
export const categories = ["All", "Python", "Machine Learning", "Web Development"];
